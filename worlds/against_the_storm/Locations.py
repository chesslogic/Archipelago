...
location_dict: Dict[str, Tuple[ATSLocationClassification, List[str]]] = {
    ...
    "2nd Reputation - Royal Woodlands": (ATSLocationClassification.biome_rep, ["Berries,Eggs,Insects,Meat,Mushrooms,Roots,Vegetables,Fish,Fish"]),
    ...
    "Trade - 100 Paste": (ATSLocationClassification.extra_trade, ["Paste"]),
    "Trade - 100 Coats": (ATSLocationClassification.extra_trade, ["Coats"]),
    "Trade - 100 Boots": (ATSLocationClassification.extra_trade, ["Boots"]),
    ...
    "Trade - 75 Dye": (ATSLocationClassification.extra_trade, ["Dye"]),
