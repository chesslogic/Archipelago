...
game_recipes = {
    ...
    'Crystallized Dew': ['Herbs,Insects,Resin,Vegetables,Algae', 'Stone,Clay', 'Planks'],
    ...
    'Pottery': ['Clay'],
    'Waterskins': ['Leather,Scales', 'Meat,Oil'],
...
blueprint_recipes = {
    ...
    'Cookhouse': {'Skewers': 2, 'Biscuits': 2, 'Dye': 2},
    ...
    'Apothecary': {'Tea': 2, 'Porridge': 2, 'Jerky': 2},
